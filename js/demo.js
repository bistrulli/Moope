var p1=new pe_prop("../images/address-book.png", "name","content",true);
var p2=new pe_prop("../images/address-book.png", "twitter","@santennio",true);
var p3=new pe_prop("../images/address-book.png", "fb","santennio",true);
var ar=new Array();
ar.push(p1);
ar.push(p2);

var item1=new pe_item("../images/address-book.png", ar,"100px");
item1.addProps(p3);
